...
Infrastructure Provider callers receive keys from their Provider's Sites. Tenant Admin callers receive keys only from Sites where `TargetedInstanceCreation` is effective. For organizations with both roles, the result is the union of the Provider's Sites and the privileged Tenant Sites. The optional siteId parameter further restricts the result.
...
Infrastructure Provider callers receive values from their Provider's Sites. Tenant Admin callers receive values only from Sites where `TargetedInstanceCreation` is effective. For organizations with both roles, the result is the union of the Provider's Sites and the privileged Tenant Sites. The optional siteId parameter further restricts the result.
