...
// NewSpectrumXPartitionManager - returns a new instance of SpectrumX Partition manager
func NewSpectrumXPartitionManager(superForge *elektratypes.Elektra, superAPI *Manager.ManagerAPI, superConf *Manager.ManagerConf) *API {
