...
pub async fn create(
    ...
    let service_query = "INSERT INTO extension_services
            ...
            RETURNING id, type, name, description, tenant_organization_id, version_ctr,
                      service_vpc_id, controller_state, controller_state_version,
                      controller_state_outcome, created, updated, deleted";
...
pub async fn update(
    ...
    builder.push(" RETURNING id, type, name, description, tenant_organization_id, version_ctr, service_vpc_id, controller_state, controller_state_version, controller_state_outcome, created, updated, deleted");
...
pub async fn update_dpf_helm_chart_in_place(
    ...
    builder.push(
        " RETURNING id, type, name, description, tenant_organization_id, version_ctr, \
          service_vpc_id, controller_state, controller_state_version, controller_state_outcome, \
...
pub async fn find_by_ids(
    ...
    let mut builder = sqlx::QueryBuilder::new(
        "SELECT id, type, name, description, tenant_organization_id, version_ctr, service_vpc_id,
